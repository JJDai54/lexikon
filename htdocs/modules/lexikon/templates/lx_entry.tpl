...
<div class="row">
    <div class="col-md-12">
        <div class="lex_term" style="margin-bottom: 0px">
        <h4><{$thisterm.term}></h4><div class="microlinks"><{$microlinks}></div>
        <{if $multicats == 1}>
            <a href="<{$xoops_url}>/modules/<{$thisterm.dir}>/category.php?categoryID=<{$thisterm.categoryID}>">
            <span class="label label-info"><{$thisterm.catname}></span>
            </a>
        <{/if}>
        </div>
        <div class="lex_term_definition">
